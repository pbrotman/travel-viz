...
const transits_init =
[{"Start": "Kuala Lumpur", "End": "Malacca", "Mode": "Bus", "Date": "07 Dec 2023"}, {"Start": "Malacca", "End": "Singapore", "Mode": "Bus", "Date": "10 Dec 2023"}, {"Start": "Singapore", "End": "Kuala Lumpur", "Mode": "Bus", "Date": "13 Dec 2023"}, {"Start": "Kuala Lumpur", "End": "Cameron Highlands", "Mode": "Bus", "Date": "14 Dec 2023"}, {"Start": "Cameron Highlands", "End": "Penang", "Mode": "Bus", "Date": "16 Dec 2023"}]
...
class Transit {
    constructor(start, end, mode, date){
...
// Generate transit objects, with references to locations.
let transits = transits_init.map((trs) => new Transit(locations_json[trs["Start"]], locations_json[trs["End"]], trs.Mode, trs.Date));
